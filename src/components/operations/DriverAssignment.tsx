...
const DriverAssignment: React.FC<DriverAssignmentProps> = ({ currentUser }) => {
  ...
  const pendingAssignments = [
    ...
    },
    {
      ...
      startTime: '8:00 AM',
      guests: 2,
      requirements: ['Romantic setup', 'Photography skills', 'Spanish speaking'],
      priority: 'medium',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Driver Assignment</h1>
          <p className="text-muted-foreground">Manage driver schedules and trip assignments</p>
        </div>
        <Button>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <span>{driver.vehicle.model} ({driver.vehicle.plate})</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{driver.languages.join(', ')}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col space-y-3 text-sm">
                      {driver.currentTrip ? (
                        <div className="bg-primary/10 p-3 rounded-lg">
                          ...
                          <p className="text-muted-foreground">#{driver.currentTrip.id}</p>
                          <p className="text-muted-foreground">{driver.currentTrip.customer}</p>
                          <div className="flex items-center space-x-2 mt-1">
                            <MapPin className="h-3 w-3 text-muted-foreground" />
                            <span>{driver.currentTrip.location}</span>
                          </div>
                          <p className="text-xs text-muted-foreground">Until {driver.currentTrip.endTime}</p>
                        </div>
                      ) : (
        ...
        <div className="space-y-6">
          <Card className="safari-card">
            <CardHeader>
              ...
              <CardDescription>Trips waiting for driver assignment</CardDescription>
            </CardHeader>
                ...
                <div key={assignment.id} className="p-4 border border-border rounded-lg space-y-3">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{assignment.package}</p>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">{assignment.startDate} at {assignment.startTime}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span>Guests:</span>
